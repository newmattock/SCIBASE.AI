...
static void DrawFrame(CGContextRef cg, int width, int height, int frame) {
  ...
  CGFloat progress = MIN(1.0, MAX(0.0, ((CGFloat)frame - 8.0) / 72.0));
  DrawText(@"AI Output Evidence Verifier", NSMakeRect(104, 595, 760, 48), 36, RGB(23, 33, 43), NSFontWeightBold);
  DrawText(@"Research-assistant output trust gate for SCIBASE issue #13", NSMakeRect(104, 563, 860, 28), 18, RGB(82, 99, 113), NSFontWeightRegular);

  DrawCard(@"Source Coverage", @[@"known sources", @"missing IDs", @"source types"], NSMakeRect(104, 362, 252, 152), RGB(233, 246, 240), RGB(159, 208, 186), RGB(23, 72, 49), RGB(39, 99, 74));
  DrawCard(@"Evidence Risk", @[@"unsupported claims", @"retracted sources", @"high-risk tags"], NSMakeRect(386, 362, 252, 152), RGB(255, 240, 230), RGB(233, 180, 137), RGB(121, 59, 16), RGB(143, 78, 32));
  DrawCard(@"Disclosure Gate", @[@"AI generated", @"human review", @"source coverage"], NSMakeRect(668, 362, 252, 152), RGB(237, 242, 251), RGB(171, 192, 231), RGB(32, 60, 105), RGB(49, 85, 143));
  DrawCard(@"Audit Digest", @[@"policy hash", @"review packet", @"stable handoff"], NSMakeRect(950, 362, 226, 152), RGB(248, 237, 247), RGB(213, 171, 208), RGB(90, 40, 84), RGB(115, 56, 107));

  FillRounded(NSMakeRect(104, 136, 1072, 174), 14, RGB(23, 33, 43));
  DrawText(@"Neurovascular Calcium Imaging Protocol", NSMakeRect(132, 250, 740, 34), 24, [NSColor whiteColor], NSFontWeightBold);
  DrawText(@"3 AI outputs, 5 claims, 3 sources, deterministic reviewer tasks", NSMakeRect(132, 209, 930, 28), 18, RGB(200, 211, 220), NSFontWeightRegular);
  DrawText(@"Recommendation: hold for evidence fix before collaborator release", NSMakeRect(132, 172, 930, 28), 18, RGB(200, 211, 220), NSFontWeightRegular);
  DrawText(@"Blocks unsupported, high-risk, and retracted-source claims", NSMakeRect(132, 135, 930, 28), 18, RGB(200, 211, 220), NSFontWeightRegular);

  FillRounded(NSMakeRect(132, 93, 980.0 * progress, 10), 5, RGB(219, 88, 66));
  DrawText(@"evidence gate running", NSMakeRect(132 + 980.0 * progress + 14, 84, 220, 28), 14, RGB(82, 99, 113), NSFontWeightMedium);
